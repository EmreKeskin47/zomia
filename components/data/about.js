...
The Zomia Center partners with local organizations. The Zomia Center does not seek to replace government services, but rather collaborates with local community groups to help build sustainable and autonomous approaches to local governance. 

The core strength of the Center is its alliance of researchers and specialists. Currently living and working across Syria, Yemen, Iraq, and Afghanistan, they have decades of experience in contested environments. By building and maintaining trusted networks, they ensure access to the data necessary for robust analysis, and help implement programs ranging from vaccination campaigns to legal redress for the victims of airstrikes. Researchers include physicians, journalists, anthropologists, and ethnographers, collaborating under the guidance of acclaimed sociologists and political theorists. 

The Center's projects are diverse.
`;

export const OUR_HISTORY = `
