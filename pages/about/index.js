...
import { bulletList1, bulletList2, ABOUT } from "../../components/data/about";
      ...
      >
        <Grid item xs={10} lg={9} alignSelf={"center"}>
          <Box marginY={5} sx={{ paddingBottom: "125px" }}>
            ...
            <RenderSubtitle text="Current Initiatives" oswald={true} />

            <Box marginBottom={10}>
              {bullet1.split("<br/>").map((paragraph, index) => {
                return <RenderBulletPoint key={index} text={paragraph} />;
              })}
            </Box>
            <RenderBody
              text={
            ...
            <RenderBody
              text={
                "Zomia is a 501(c)(3) nonprofit organization registered in the United States under EIN: 30-1201889, and all donations are tax deductible. If you would like to donate, please contact us at info@zomiacenter.org. We thank you in advance for your support."
              }
            />
